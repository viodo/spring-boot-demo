package org.viodo.hadoop.client;
...
public class HdfsTemplate {
    ...
    public HdfsTemplate(Configuration conf, String defaultHdfsUri) {
        this.conf = conf;
    ...
    public void uploadFileToHdfs(String srcFile, String dstPath) {
        this.uploadFile(false, true, srcFile, dstPath);
    }
     ...
     * @param dstPath   HDFS的相对目录路径，比如：/testDir
     */
    public void uploadFile(boolean delSrc, boolean overwrite, String srcFile, String dstPath) {
        // 源文件路径
